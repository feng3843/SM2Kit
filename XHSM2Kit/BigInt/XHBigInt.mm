...
using namespace com::XHspace::bigint;
...
- (instancetype)initWithString:(NSString *)valueString radix:(int)radix
{
    ...
    if (![XHBigInt canParseBigIntegerFromString:valueString radix:radix])
    {
        return nil;
    }
...
- (instancetype)initWithRandomBits:(int)bits
{
    ...
    if (bits > 0)
    {
        ...
        return [[XHBigInt alloc] initWithString:[mutStr copy] radix:2];
    }
    else
    {
        return XHBigInt.zero;
    }
}
...
+ (XHBigInt *)zero
{
    static XHBigInt *_zeroInstance = nil;
    static dispatch_once_t zeroPredicate;
    
    dispatch_once(&zeroPredicate, ^{
        _zeroInstance = [[XHBigInt alloc] initWithInt:0];
    });
...
+ (XHBigInt *)one
{
    static XHBigInt *_oneInstance = nil;
    static dispatch_once_t onePredicate;
    
    dispatch_once(&onePredicate, ^{
        _oneInstance = [[XHBigInt alloc] initWithInt:1];
    });
...
{
    XHBigInt *sum = [[XHBigInt alloc] init];
...
{
    XHBigInt *difference = [[XHBigInt alloc] init];
...
{
    XHBigInt *product = [[XHBigInt alloc] init];
...
{
    return [self multiplyByBigInt:[[XHBigInt alloc] initWithInt:value]];
}
...
{
    return [self divideByBigInt:[[XHBigInt alloc] initWithInt:value]];
}
...
{
    return [self reminderByBigInt:[[XHBigInt alloc] initWithInt:value]];
}


- (XHBigInt_QuotientAndRemainder *)divideAndReminderByBigInt:(XHBigInt *)value
{
    XHBigInt *quotien = [[XHBigInt alloc] init];
    XHBigInt *reminder = [[XHBigInt alloc] init];
    ...
    return [[XHBigInt_QuotientAndRemainder alloc] initWithQuotient:quotien reminder:reminder];
}
...
{
    XHBigInt *power = [[XHBigInt alloc] init];
...
{
    XHBigInt *res = [[XHBigInt alloc] init];
...
- (XHBigInt *)square
{
    XHBigInt *b = [[XHBigInt alloc] initWithBigInteger:self];
...
- (XHBigInt *)sqrt
{
    XHBigInt *sqrt = [[XHBigInt alloc] init];
...
- (XHBigInt *)negate
{
    XHBigInt *negated = [[XHBigInt alloc] init];
...
- (XHBigInt *)abs
{
    XHBigInt *absolute = [[XHBigInt alloc] init];
...
{
    return [self bitwiseXorByBigInt:[[XHBigInt alloc] initWithInt:value]];
}
...
{
    return [self bitwiseOrByBigInt:[[XHBigInt alloc] initWithInt:value]];
}
...
{
    return [self bitwiseAndByBigInt:[[XHBigInt alloc] initWithInt:value]];
}
...
{
    XHBigInt *leftShifted = [[XHBigInt alloc] init];
...
{
    XHBigInt *rightShifted = [[XHBigInt alloc] init];
...
{
    XHBigInt *gcd = [[XHBigInt alloc] init];
...
{
    return [self gcdByBigInt:[[XHBigInt alloc] initWithInt:value]];
}
...
{
    return [self modInverseByBigInt:[[XHBigInt alloc] initWithInt:n]];
}
...
{
    return [self modByBigInt:[[XHBigInt alloc] initWithInt:n]];
}
...
@implementation XHBigInt_QuotientAndRemainder
